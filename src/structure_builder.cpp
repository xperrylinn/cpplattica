...
PeriodicStructure StructureBuilder::build(int size, int num_procs, int rank) {
    ...
    PeriodicStructure periodic_struc = PeriodicStructure::build_from(this->lattice, num_cells, this->motif, num_procs, rank, this->frac_coords);
